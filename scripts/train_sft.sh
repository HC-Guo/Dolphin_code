...
output_dir=./checkpoints/sft/${run_name}_${ori_checkpoint_name}_sft_do_${datetime}
...
# Setup conda environment (adjust path according to your environment)
...
# Change to your LLaMA-Factory directory
cd .
...
new_yaml_path="./configs/${yaml_filename}_${datetime}.yaml"
